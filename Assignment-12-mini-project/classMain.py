...
from classDocumentary import Documentary
from ClassClip import Clip

PRODUCTS = []

def read_from_database():
    with open("E:\python home work\python-corse\python-corse\Assignment-12-mini-project\dataBase.txt", encoding="utf8") as f:
